...
`))i.startsWith("d")&&this._deletedFiles.add(i.slice(1))}checkInitialized(){if(!this._isInitialized)throw new u(1,"OverlayFS is not initialized. Please initialize OverlayFS using its initialize() method before using it.");if(!this._deleteLogError)return;let i=this._deleteLogError;throw delete this._deleteLogError,i}checkPath(i){if(i==ta)throw u.With("EPERM",i,"checkPath")}createParentDirectoriesSync(i){let n=E(i),r=[];for(;!this.writable.existsSync(n);)r.push(n),n=E(n);for(let s of r.reverse())this.writable.mkdirSync(s,this.statSync(s).mode)}async createParentDirectories(i){let n=E(i),r=[];for(;!await this.writable.exists(n);)r.push(n),n=E(n);for(let s of r.reverse()){let a=await this.stat(s);await this.writable.mkdir(s,a.mode)}}operateOnWritable(i){if(!this.existsSync(i))throw u.With("ENOENT",i,"operateOnWriteable");this.writable.existsSync(i)||this.copyToWritableSync(i)}async operateOnWritableAsync(i){if(!await this.exists(i))throw u.With("ENOENT",i,"operateOnWritable");if(!await this.writable.exists(i))return this.copyToWritable(i)}copyToWritableSync(i){let n=this.statSync(i);if(n.isDirectory()){this.writable.mkdirSync(i,n.mode);return}let r=new Uint8Array(n.size),s=this.readable.openFileSync(i,D("r"));s.readSync(r),s.closeSync();let a=this.writable.openFileSync(i,D("w"));a.writeSync(r),a.closeSync()}async copyToWritable(i){let n=await this.stat(i);if(n.isDirectory()){await this.writable.mkdir(i,n.mode);return}let r=new Uint8Array(n.size),s=await this.readable.openFile(i,D("r"));await s.read(r),await s.close();let a=await this.writable.openFile(i,D("w"));await a.write(r),await a.close()}},vn=class extends ea(Wr){static{o(this,"OverlayFS")}},kw={name:"Overlay",options:{writable:{type:"object",required:!0,description:"The file system to write modified files to."},readable:{type:"object",required:!0,description:"The file system that initially populates this file system."}},isAvailable:o(function(){return!0},"isAvailable"),create:o(function(t){return new vn(t)},"create")},vw=kw;function Fw(t){class e extends t{static{o(this,"SyncFS")}async exists(n){return this.existsSync(n)}async rename(n,r){return this.renameSync(n,r)}async stat(n){return this.statSync(n)}async createFile(n,r,s){return this.createFileSync(n,r,s)}async openFile(n,r){return this.openFileSync(n,r)}async unlink(n){return this.unlinkSync(n)}async rmdir(n){return this.rmdirSync(n)}async mkdir(n,r){return this.mkdirSync(n,r)}async readdir(n){return this.readdirSync(n)}async link(n,r){return this.linkSync(n,r)}async sync(n,r,s){return this.syncSync(n,r,s)}}return e}o(Fw,"Sync");var Iw=_n;return kd(Aw);});
